		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zmm_sayimkokpit",
									"targetURL": "#zmm_sayimkokpit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmm_sayimkokpit-display": {
								"semanticObject": "zmm_sayimkokpit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.isuzu.zmmsayimkokpit",
									"url": sap.ui.require.toUrl("com/isuzu/zmmsayimkokpit")
								}
							}
						}
					}
